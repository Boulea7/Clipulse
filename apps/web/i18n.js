...
const EN_MESSAGES = {
  ...
  'settings.visibleProviders': 'Visible Providers',
  'settings.statusDisplay': 'Status item',
...
const LOCALE_MESSAGES = {
  'zh-CN': {
    ...
    'settings.visibleProviders': '可见 Provider',
    'settings.statusDisplay': '状态栏显示',
    'settings.theme': '主题',
  ...
  'zh-TW': {
    ...
    'section.providers': 'Provider',
    'section.settings': '設定',
    'view.reportsTitle': '使用報表',
    'view.providersTitle': 'Provider 與配額',
    'view.settingsTitle': '本機設定',
    'view.reportsDescription': '查看私有 API 彙總的每日 Token、費用、時間、工作階段和 block 資料。',
    'view.providersDescription': '查看本機 Provider 彙總和 P0 配額契約；不會讀取 Provider credential。',
    'view.settingsDescription': '管理安裝、PWA、選單列和隱私優先的本機設定入口。',
    'report.tokensToday': '今日 Token',
    'report.costEstimate': '費用估算',
    'report.activeWait': '活躍 / 等待',
    'report.rowsLatest': '列數 / 最新',
    'report.tokensTodayLabel': '今日 Token',
    'report.rows': '列數',
    'provider.summaries': 'Provider 彙總',
    'provider.observedLocally': '本機已觀測',
    'provider.polling': '輪詢',
    'provider.disabledP0': 'P0 暫未啟用',
    'provider.notObserved': '未觀測',
    'provider.unknown': '未知',
    ...
    'settings.view': '視圖',
    'settings.refresh': '刷新',
    'settings.visibleMetrics': '可見指標',
    'settings.visibleProviders': '可見 Provider',
    'settings.statusDisplay': '狀態項目',
    'settings.theme': '主題',
    'settings.pwaCache': 'PWA 只快取安全靜態 shell；私有 API response 始終走網路。',
    'settings.menubarApi': '選單列 API',
    'settings.menubarView': '選單列視圖',
    'settings.refreshInterval': '刷新間隔',
    'settings.pwaCacheLabel': 'PWA 快取',
    'settings.staticShellOnly': '僅快取靜態 shell',
    'detail.reportsDescription': '每日報表來自私有 P0 usage report API。',
    'detail.providersDescription': 'Provider 卡片在 P0 使用本機彙總；真實 Provider 輪詢暫未啟用。',
    'detail.settingsDescription': '選單列偏好與 PWA 安裝資產透過私有本機介面暴露。',
    'message.noProviderSummariesYet': '還沒有 Provider 彙總。新的 usage event 會產生本機 Provider 卡片。',
    'message.loadingUsageReports': '正在載入使用報表...',
    'message.loadingProviderSummaries': '正在載入 Provider 彙總...',
    'message.loadingMenubarSettings': '正在載入選單列設定...',
    'message.unableLoadUsageReports': '暫時無法載入使用報表。',
    'message.unableLoadProviderSummaries': '暫時無法載入 Provider 彙總。',
    'message.unableLoadMenubarSettings': '暫時無法載入選單列設定。',
    'message.invalidUsageReportPayload': '使用報表 payload 無效。',
    'message.invalidProvidersPayload': 'Provider payload 無效。',
    'message.invalidMenubarPreferencesPayload': '選單列偏好 payload 無效。',
    'unit.day.one': '天',
    'unit.day.other': '天',
    'unit.hr.one': '小時',
    'unit.hr.other': '小時',
