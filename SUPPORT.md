...
- Use `CONTRIBUTING.md` for contribution expectations, validation notes, and public docs rules.
- Use `CODE_OF_CONDUCT.md` for community standards in issues, discussions, and pull requests.

## What To Include In A Support Request

- Which host CLI you are using, such as `Claude Code`, `Codex`, `Gemini CLI`, or `OpenCode`
- Your platform and relevant runtime versions, including Node, Python, and `uv` when applicable
- The smallest reproducible command or config snippet that shows the problem
- Any checks you already ran, such as `npm run smoke:repo-guardrails`, `curl /healthz`, or `curl /api/v1/status`
